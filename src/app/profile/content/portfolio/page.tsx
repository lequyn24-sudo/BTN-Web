    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <button className="flex items-center gap-2 px-4 py-2 bg-card border border-border/50 text-foreground text-sm font-semibold rounded-lg hover:bg-white/10 transition-colors w-fit">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="md:col-span-2 bg-card rounded-xl border border-border/50 p-6 flex flex-col justify-between">
          <div>
            <h3 className="text-sm font-medium text-foreground/70 mb-1">Total Balance</h3>
            <div className="flex items-end gap-3">
              <span className="text-4xl font-bold text-foreground">$24,203.51</span>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8 pt-6 border-t border-border/30">
            <div className="flex flex-col gap-1">
              ...
              <span className="text-sm font-medium text-foreground">$18,450.00</span>
            </div>
            <div className="flex flex-col gap-1">
        ...
        <div className="bg-card rounded-xl border border-border/50 p-6 flex flex-col items-center justify-center relative min-h-[200px]">
          <PieChart className="w-24 h-24 text-primary/20 absolute" />
          <div className="relative z-10 text-center">
            <h3 className="text-lg font-bold text-foreground mb-4">Asset Allocation</h3>
            <div className="flex flex-col gap-2 w-full max-w-[150px] mx-auto text-sm">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="font-mono text-foreground">25%</span>
              </div>
              <div className="flex justify-between items-center">
      ...
      <div className="bg-card rounded-xl border border-border/50 flex flex-col overflow-hidden">
        <div className="p-6 border-b border-border/50 flex justify-between items-center">
          <h3 className="text-lg font-medium text-foreground">Your Assets</h3>
          <div className="flex gap-2">
            <button className="px-3 py-1 bg-card border border-border rounded text-xs font-medium text-foreground hover:bg-white/10 transition-colors">Hide Small Balances</button>
          </div>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse min-w-[700px]">
            ...
            <tbody className="divide-y divide-border/50 text-sm">
              {assets.map((asset) => (
                <tr key={asset.id} className="hover:bg-card transition-colors group cursor-pointer">
                  <td className="py-4 px-6">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        <span className="font-bold text-foreground group-hover:text-primary transition-colors">{asset.name}</span>
