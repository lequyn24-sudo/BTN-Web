...
export default function InvestmentProfilePage() {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground mb-2">Investment Profile</h1>
      ...
      <div className="bg-card rounded-xl border border-border/50 p-6 flex flex-col gap-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="text-lg font-medium text-foreground">Experience Level</h3>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <label className="relative flex flex-col gap-2 p-4 rounded-xl border-2 border-border/50 bg-card cursor-pointer hover:border-primary/50 transition-colors">
          ...
          <label className="relative flex flex-col gap-2 p-4 rounded-xl border-2 border-primary bg-primary/5 cursor-pointer">
            ...
            <span className="text-sm font-bold text-foreground">Intermediate</span>
      ...
      <div className="bg-card rounded-xl border border-border/50 p-6 flex flex-col gap-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h3 className="text-lg font-medium text-foreground">Topics of Interest</h3>
        ...
        <div className="flex flex-wrap gap-3">
          {["Bitcoin", "Ethereum", "Altcoins", "DeFi", "NFTs", "GameFi", "Regulation", "Mining", "Trading Strategies", "Airdrops", "Memecoins", "Macroeconomics"].map((topic, i) => (
            <label key={topic} className="relative cursor-pointer">
              ...
              <div className="px-4 py-2 rounded-full border border-border/50 bg-card text-sm font-medium text-foreground/70 peer-checked:bg-primary/20 peer-checked:border-primary/50 peer-checked:text-primary transition-colors hover:bg-white/10">
                {topic}
              </div>
            </label>
          ))}
      ...
      <div className="bg-card rounded-xl border border-border/50 p-6 flex flex-col gap-6">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="text-lg font-medium text-foreground">Primary Goal</h3>
        </div>
        
        <div className="relative max-w-md">
          <select className="w-full appearance-none bg-card border border-border/50 rounded-lg pl-4 pr-10 py-3 text-sm text-foreground focus:outline-none focus:border-primary/50 transition-colors cursor-pointer">
