...
export default function IdentityPage() {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground mb-2">Identity</h1>
      ...
      <div className="bg-card rounded-xl border border-border/50 p-6 flex flex-col md:flex-row gap-6 items-center">
        ...
        <div className="flex flex-col gap-2 text-center md:text-left">
          ...
          <div className="flex gap-3 justify-center md:justify-start mt-2">
            ...
            <button className="px-4 py-2 bg-card border border-border text-foreground text-sm font-semibold rounded-lg hover:bg-white/10 transition-colors">
              Remove
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-card border border-border/50 rounded-lg pl-10 pr-4 py-2.5 text-sm text-foreground focus:outline-none focus:border-primary/50 transition-colors"
              />
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="relative">
              ...
              <input 
                ...
                className="w-full bg-card border border-border/50 rounded-lg pl-8 pr-4 py-2.5 text-sm text-foreground focus:outline-none focus:border-primary/50 transition-colors"
              />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-2 md:col-span-2">
            ...
            <textarea 
              ...
              className="w-full bg-card border border-border/50 rounded-lg p-4 text-sm text-foreground focus:outline-none focus:border-primary/50 transition-colors resize-none"
