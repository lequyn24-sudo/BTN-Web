  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-foreground/60 text-sm">Manage your subscription settings and preferences.</p>
      </div>
      ...
      <div className="bg-black/20 rounded-xl border border-border/50 p-8 flex flex-col items-center justify-center min-h-[300px] text-center">
        ...
        <p className="text-sm text-foreground/50 max-w-md">The Subscription module is currently under development. Please check back later for updates.</p>
      </div>
    </div>
  );
}