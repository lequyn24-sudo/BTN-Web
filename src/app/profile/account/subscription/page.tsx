...
export default function SubscriptionPage() {
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* Current Plan */}
      <div className="bg-black/20 rounded-xl border border-primary/30 p-6 flex flex-col gap-6 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row justify-between gap-6 relative z-10">
          <div>
            ...
            <h3 className="text-2xl font-bold text-white mb-1">Bitcoin Info Pro</h3>
            ...
            <div className="flex gap-3">
              ...
              <button className="px-5 py-2.5 bg-white/5 border border-border text-white text-sm font-semibold rounded-lg hover:bg-white/10 transition-colors">
                Cancel Plan
              </button>
            </div>
          </div>
          ...
          <div className="bg-background/40 border border-border/50 rounded-xl p-5 md:w-64 shrink-0 h-fit">
            <h4 className="text-sm font-medium text-white mb-3">Next Payment</h4>
            <div className="flex justify-between items-center mb-1">
              <span className="text-sm text-foreground/70">Date:</span>
              <span className="text-sm font-medium text-white">Jul 15, 2026</span>
            </div>
            <div className="flex justify-between items-center mb-4">
              <span className="text-sm text-foreground/70">Amount:</span>
              <span className="text-sm font-medium text-white">$14.99</span>
            </div>
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-border/50 text-sm">
              <tr className="hover:bg-white/5 transition-colors">
                <td className="py-4 px-6 text-white">Jun 15, 2026</td>
                ...
                <td className="py-4 px-6 text-white font-medium">$14.99</td>
              ...
              <tr className="hover:bg-white/5 transition-colors">
                <td className="py-4 px-6 text-white">May 15, 2026</td>
                <td className="py-4 px-6 text-foreground/80">Pro Plan - Monthly</td>
                <td className="py-4 px-6">
                  <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full bg-green-500/10 text-green-500 text-xs font-medium border border-green-500/20">
                    <CheckCircle2 className="w-3 h-3" /> Paid
              ...
              <tr className="hover:bg-white/5 transition-colors">
                <td className="py-4 px-6 text-white">Apr 15, 2026</td>
                <td className="py-4 px-6 text-foreground/80">Pro Plan - Monthly</td>
                <td className="py-4 px-6">
                  <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded-full bg-green-500/10 text-green-500 text-xs font-medium border border-green-500/20">
                    <CheckCircle2 className="w-3 h-3" /> Paid
