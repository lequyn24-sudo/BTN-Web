    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="bg-black/20 rounded-xl border border-border/50 p-6 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-2 md:col-span-2">
            ...
            <input 
              type="password" 
              placeholder="••••••••"
              className="w-full bg-black/50 border border-border/50 rounded-lg px-4 py-2.5 text-sm text-white focus:outline-none focus:border-primary/50 transition-colors"
            />
          </div>
        ...
        <div className="flex justify-end mt-2">
          <button className="px-6 py-2.5 bg-white/5 border border-border text-white text-sm font-semibold rounded-lg hover:bg-white/10 transition-colors">
            Update Password
          </button>
        </div>
      </div>
      ...
      <div className="bg-black/20 rounded-xl border border-border/50 p-6 flex flex-col gap-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            <span className="ml-3 text-sm font-medium text-white">Enabled</span>
          </label>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex justify-between items-center border-b border-border/50 pb-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col">
                <span className="text-sm font-medium text-white">iPhone 14 Pro • Safari</span>
