...
export default function ReputationPage() {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-3xl font-bold text-white mb-2">Community Reputation</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-black/20 rounded-xl border border-border/50 p-5 flex flex-col gap-2">
          <div className="flex items-center gap-2 text-primary">
            <Trophy className="w-5 h-5" />
            <span className="font-medium">Reputation Score</span>
          </div>
          <div className="flex items-end gap-2">
            <span className="text-4xl font-bold text-white">4,250</span>
        ...
        <div className="bg-black/20 rounded-xl border border-border/50 p-5 flex flex-col justify-between">
          <div className="flex items-center gap-2 text-foreground/70">
            <Shield className="w-5 h-5" />
            <span className="font-medium">Current Rank</span>
          </div>
          <div>
            <span className="text-2xl font-bold text-white block">Market Analyst</span>
        ...
        <div className="bg-black/20 rounded-xl border border-border/50 p-5 flex flex-col justify-between">
          ...
          <div>
            <span className="text-2xl font-bold text-white block">14 Days</span>
      ...
      <div className="bg-black/20 rounded-xl border border-border/50 p-6 flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <h3 className="text-lg font-medium text-white">Earned Badges</h3>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-6 gap-4">
          <div className="flex flex-col items-center gap-2 p-3 rounded-lg border border-primary/30 bg-primary/5 text-center group cursor-pointer hover:bg-primary/10 transition-colors">
            ...
            <span className="text-xs font-bold text-white mt-1">Early Adopter</span>
            <span className="text-[10px] text-foreground/50">Joined in 2024</span>
          </div>
          
          <div className="flex flex-col items-center gap-2 p-3 rounded-lg border border-border/50 bg-white/5 text-center group cursor-pointer hover:bg-white/10 transition-colors">
            ...
            <span className="text-xs font-bold text-white mt-1">Top Commenter</span>
          ...
          <div className="flex flex-col items-center gap-2 p-3 rounded-lg border border-border/50 bg-white/5 text-center group cursor-pointer hover:bg-white/10 transition-colors">
            ...
            <span className="text-xs font-bold text-white mt-1">Fact Checker</span>
            <span className="text-[10px] text-foreground/50">Reported errors</span>
          </div>
          
          {/* Locked badges */}
          <div className="flex flex-col items-center gap-2 p-3 rounded-lg border border-border/20 bg-black/40 text-center opacity-60">
            <div className="w-12 h-12 rounded-full bg-white/5 border border-dashed border-white/20 flex items-center justify-center grayscale">
      ...
      {/* How to earn */}
      <div className="bg-black/20 rounded-xl border border-border/50 p-6 flex flex-col gap-6">
        <h3 className="text-lg font-medium text-white">How to earn points</h3>
