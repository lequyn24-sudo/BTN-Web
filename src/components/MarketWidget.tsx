...
export function MarketWidget({ initialData }: { initialData: MarketData | null }) {
  ...
  return (
    <div className="glass rounded-2xl p-5 h-full flex flex-col justify-between border-border bg-[#0a0a0a]/80 shadow-2xl shadow-black/50 w-full max-w-sm mx-auto lg:max-w-none velocity-glow-hover">
      {/* Top Section */}
