...
export async function HeroSection() {
  ...
  return (
    <section className="mb-12 grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
      <Link href={`/article/${featuredArticle.slug}`} className="lg:col-span-2 relative rounded-[24px] skeuo-card velocity-glow-hover group cursor-pointer h-full min-h-[450px] block p-2 transition-transform hover:-translate-y-1">
        ...
        <div className="absolute inset-2 z-20 flex flex-col justify-end p-6 md:p-10 pointer-events-none">
